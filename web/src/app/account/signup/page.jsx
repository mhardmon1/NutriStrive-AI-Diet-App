  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const timeoutId = setTimeout(() => {
        setLoading(false);
        setError("Sign up is taking too long. Please try again.");
      }, 15000); // 15 second timeout for signup

      // Store the profile data temporarily in sessionStorage
      ...
      // Create the authentication account with redirect to home
      ...
      // If successful, manually redirect to home page
      if (result?.ok) {
      ...
      // Clear pending profile data on error
      if (typeof window !== "undefined") {
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Join MOBA</h1>
          <p className="text-gray-600">
            Start your performance nutrition journey
          </p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-lg outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all appearance-none disabled:opacity-50"
                disabled={loading}
              >
